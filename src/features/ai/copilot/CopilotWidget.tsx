...
export const CopilotWidget: React.FC = memo(() => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-[450]" dir="rtl">
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          onClick={handleToggle}
          className="relative group flex items-center gap-2.5 px-4 py-3 bg-gradient-to-r from-[#1E4D4D] via-[#1a4444] to-[#143737] text-white rounded-2xl shadow-xl shadow-teal-900/25 border border-teal-400/30 cursor-pointer overflow-hidden"
        ...
        >
          ...
          {/* Icon */}
          <div className="p-1.5 bg-teal-500/20 rounded-xl text-teal-300 group-hover:text-white transition-colors">
            <Bot size={20} className={isOpen ? '' : 'animate-bounce'} />
          </div>
